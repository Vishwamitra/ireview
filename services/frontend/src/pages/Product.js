...
class Component extends React.Component {
    ...
    deleteReview = (id) => { 
        axios.post(`http://localhost:${process.env.REACT_APP_BACKEND_PORT}/review-delete`, {
            ReviewID: id
        }).then(() => { 
            var reviews = this.state.productInfo.reviews
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:${process.env.REACT_APP_BACKEND_PORT}/product/${id}`).then(productInfo => {
            axios.get(`http://localhost:${process.env.REACT_APP_BACKEND_PORT}/product/${id}/reviews`).then(reviews => {
                this.setState({
                    isLoading: false,
                    productInfo: {
                        ...productInfo.data,
